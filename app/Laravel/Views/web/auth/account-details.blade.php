...
@section('content')
  ...
  <div class="tw-h-screen tw-flex tw-overflow-hidden tw-bg-white">
    ...
    <div class="tw-flex tw-flex-col tw-w-0 tw-flex-1 tw-overflow-y-auto">
      <section>
        <div class="container">
          <h5 class="text-title pb-3"><i class="fa fa-pencil-alt"></i> CREATE
            ACCOUNT
          </h5>
              ...
              <form method="POST" action="" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                      <div class="radio-item" style="padding-right: 5em">
                        <input type="radio" id="rbtn_1" name="account_type"
                          value="company" @if (old('account_type') == 'company' || Session::get('registration.account_type') == 'company') checked @endif>
                        <label for="rbtn_1">Company</label>
                      </div>
                      <div class="radio-item">
                        <input type="radio" id="rbtn_2" name="account_type"
                          value="contractor" @if (old('account_type') == 'contractor' || Session::get('registration.account_type') == 'contractor') checked @endif>
                ...
                <div class="row mt-1">
                  <div class="col-md-6 col-lg-6" id="undertaking_container">
                    <div class="form-group">
                      <label
                        class="text-form pb-2 fw-600">PCAB/UNDERTAKING</label>
                ...
                <p class="text-title fw-600">Please Take note of your email
                  address
                  and password used</p>
                <div class="row">
                  <div class="col-md-12 col-lg-12" id="contractor_id_container">
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control form-control-lg {{ $errors->first('contractor_id') ? 'is-invalid' : null }}"
                        name="contractor_id" placeholder="ContractorID"
                        value="{{ old('contractor_id', Session::get('registration.contractor_id')) }}">
                      @if ($errors->first('contractor_id'))
                        <small class="form-text pl-1"
                          style="color:red;">{{ $errors->first('contractor_id') }}</small>
                      @endif
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12 col-lg-12" id="contractor_name_container">
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control form-control-lg {{ $errors->first('contractor_name') ? 'is-invalid' : null }}"
                        name="contractor_name" placeholder="ContractorName"
                        value="{{ old('contractor_name', Session::get('registration.contractor_name')) }}">
                      @if ($errors->first('contractor_name'))
                        <small class="form-text pl-1"
                          style="color:red;">{{ $errors->first('contractor_name') }}</small>
                      @endif
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6 col-lg-6" id="validity_period_container">
                    <div class="form-group">
                      ...
                      <input type="date"
                        class="form-control form-control-lg br-right-white p-2"
                        name="validity_period" placeholder="YYYY-MM-DD"
                        value="{{ old('validity_period', Session::get('registration.validity_period')) }}">
                      @if ($errors->first('validity_period'))
                        <small class="form-text pl-1"
                          style="color:red;">{{ $errors->first('validity_period') }}</small>
                      @endif
                    </div>
                  </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text text-title fw-600"
                            style="border-right: none;">+63 <span
                              class="pr-1 pl-2"
                              style="padding-bottom: 2px"> |</span></span>
                        </div>
                        <input type="text"
                          class="form-control form-control-lg br-left-white {{ $errors->first('contractor_contact_number') ? 'is-invalid' : null }}"
                          name="contractor_contact_number"
                          placeholder="XXX-XXX-XXXX"
                          value="{{ old('contractor_contact_number', Session::get('registration.contractor_contact_number')) }}">
                      </div>
                      @if ($errors->first('contractor_contact_number'))
                        <small class="form-text pl-1"
                          style="color:red;">{{ $errors->first('contractor_contact_number') }}</small>
                      @endif
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12 col-lg-12" id="classification_container">
                    <div class="form-group">
                      <label class="text-form pb-2 fw-600">Principal
                        Classification
                        and Category</label>
                      <input type="text"
                        class="form-control form-control-lg {{ $errors->first('classification') ? 'is-invalid' : null }}"
                        name="classification" placeholder="Category"
                        value="{{ old('classification', Session::get('registration.classification')) }}">
                      @if ($errors->first('classification'))
                        <small class="form-text pl-1"
                          style="color:red;">{{ $errors->first('classification') }}</small>
                      @endif
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12 col-lg-12"
                    id="other_classification_container">
                    <div class="form-group">
                      <label class="text-form pb-2 fw-600">Other
                        Classification</label>
                      <input type="text"
                        class="form-control form-control-lg {{ $errors->first('other_classification') ? 'is-invalid' : null }}"
                        name="other_classification" placeholder="Classification"
                        value="{{ old('other_classification', Session::get('registration.other_classification')) }}">
                      @if ($errors->first('other_classification'))
                        <small class="form-text pl-1"
                          style="color:red;">{{ $errors->first('other_classification') }}</small>
                      @endif
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-12 col-lg-12" id="company_name_container">
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control form-control-lg {{ $errors->first('company_name') ? 'is-invalid' : null }}"
                        name="company_name" placeholder="Company Name"
                        value="{{ old('company_name', Session::get('registration.company_name')) }}">
                      @if ($errors->first('company_name'))
                        <small class="form-text pl-1"
                          style="color:red;">{{ $errors->first('company_name') }}</small>
                      @endif
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12 col-lg-12" id="company_address_container">
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control form-control-lg {{ $errors->first('company_address') ? 'is-invalid' : null }}"
                        name="company_address" placeholder="Company Address"
                        value="{{ old('company_address', Session::get('registration.company_address')) }}">
                      @if ($errors->first('company_address'))
                        <small class="form-text pl-1"
                          style="color:red;">{{ $errors->first('company_address') }}</small>
                      @endif
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6 col-lg-16" id="firstname_container">
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control form-control-lg {{ $errors->first('company_first_name') ? 'is-invalid' : null }}"
                        name="company_first_name" placeholder="First Name"
                        value="{{ old('company_first_name', Session::get('registration.company_first_name')) }}">
                      @if ($errors->first('company_first_name'))
                        <small class="form-text pl-1"
                          style="color:red;">{{ $errors->first('company_first_name') }}</small>
                      @endif
                    </div>
                  </div>
                  <div class="col-md-6 col-lg-16" id="lastname_container">
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control form-control-lg {{ $errors->first('company_last_name') ? 'is-invalid' : null }}"
                        name="company_last_name" placeholder="Last Name"
                        value="{{ old('company_last_name', Session::get('registration.company_last_name')) }}">
                      @if ($errors->first('company_last_name'))
                        <small class="form-text pl-1"
                          style="color:red;">{{ $errors->first('company_last_name') }}</small>
                      @endif
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6 col-lg-16" id="middlename_container">
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control form-control-lg {{ $errors->first('company_middle_name') ? 'is-invalid' : null }}"
                        name="company_middle_name" placeholder="Middle Name"
                        value="{{ old('company_middle_name', Session::get('registration.company_middle_name')) }}">
                      @if ($errors->first('company_middle_name'))
                        <small class="form-text pl-1"
                          style="color:red;">{{ $errors->first('company_middle_name') }}</small>
                      @endif
                    </div>
                  </div>
                  <div class="col-md-6 col-lg-16" id="email_container">
                    <div class="form-group">
                      <label class="text-form pb-2 fw-600">Email</label>
                      <input type="email"
                        class="form-control form-control-lg {{ $errors->first('company_email') ? 'is-invalid' : null }}"
                        name="company_email" placeholder="username@email.com"
                        value="{{ old('company_email', Session::get('registration.company_email')) }}">
                      @if ($errors->first('company_email'))
                        <small class="form-text pl-1"
                          style="color:red;">{{ $errors->first('company_email') }}</small>
                      @endif
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-6 col-lg-16" id="mobile_container">
                    <div class="form-group">
                      ...
                      <div class="input-group mb-3">
                        ...
                        <input type="text"
                          class="form-control form-control-lg br-left-white {{ $errors->first('company_contact_number') ? 'is-invalid' : null }}"
                          name="company_contact_number" placeholder="XXX-XXX-XXXX"
                          value="{{ old('company_contact_number', Session::get('registration.company_contact_number')) }}">
                      </div>
                      @if ($errors->first('company_contact_number'))
                        <small class="form-text pl-1"
                          style="color:red;">{{ $errors->first('company_contact_number') }}</small>
                      @endif
                    </div>
                  </div>
                  <div class="col-md-6 col-lg-16" id="telephone_container">
                    <div class="form-group">
                      <label class="text-form pb-2 fw-600">Telephone
                        Number</label>
                      <input type="text"
                        class="form-control form-control-lg {{ $errors->first('tel_number') ? 'is-invalid' : null }}"
                        name="tel_number" placeholder="(XX) XXX-XXXX"
                        value="{{ old('tel_number', Session::get('registration.tel_number')) }}">
                      @if ($errors->first('tel_number'))
                        <small class="form-text pl-1"
                          style="color:red;">{{ $errors->first('tel_number') }}</small>
                      @endif
                    </div>
                  </div>
                </div>
                <button type="submit"
                  class="btn secondary-solid-btn px-5 py-3 fs-14 float-right"><i
                    class="fa fa-paper-plane pr-2"></i>Next</button>
              </form>
            </div>
          </div>
        </div>
