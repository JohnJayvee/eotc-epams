  ...
  <div class="col-md-4">
    <div class="form-group"> 
      <div class="radio-item">
        ...
        <label for="chck_erection">Erection <input type="text" name="erection" value="{{old('erection')}}" class="check-input" value="{{old('erection')}}"></label>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="col-md-4">
    <div class="form-group"> 
      <div class="radio-item">
        ...
        <label for="chck_addtion">Addition <input type="text" name="addition" value="{{old('addition')}}" class="check-input"></label>
      </div>
    </div>
  </div>
  <div class="col-md-4">
  ...
  <div class="col-md-6">
    <div class="form-group"> 
      <div class="radio-item">
        ...
        <label for="chck_others">Others(specify) <input type="text" name="others" value="{{old('others')}}" class="check-input"></label>
      </div>
    </div>
  </div>
</div>
