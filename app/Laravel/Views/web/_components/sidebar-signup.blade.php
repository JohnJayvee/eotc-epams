<div class="tw-flex tw-flex-shrink-0">
  <div class="tw-flex tw-flex-col">
    <div class="tw-flex tw-flex-col tw-h-0 tw-flex-1">
      <div
        class="guest-sidebar tw-flex-1 tw-flex tw-flex-col tw-overflow-y-auto tw-bg-blue tw-text-white tw-py-20 tw-px-16">
