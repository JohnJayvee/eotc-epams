...
<div class="col-md-8 grid-margin stretch-card">
  <div class="card">
    <div class="card-body">
      <h4 class="card-title">Company Create Form</h4>
      <form class="create-form" method="POST" enctype="multipart/form-data">
        ...
        {!!csrf_field()!!}
            ...
            <p class="help-block">Please download the <a href="{{asset('template/company_template.xlsx')}}"><strong>mass upload template(.xls) <i class="fa fa-download"></i> </strong></a> template to upload bulk Company.</p>
