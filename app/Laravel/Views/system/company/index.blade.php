  ...
  <div class="col-md-12">
    <h4 class="pb-4">Record Data
      <span class="float-right">
        <a href="{{route('system.company.upload')}}" class="btn btn-sm btn-primary">Bulk Upload</a>
      </span>
    </h4>
    <div class="table-responsive shadow fs-15">
      <table class="table table-striped">
        <thead>
          <tr>
            <th class="text-title p-3">Entity Code</th>
          ...
          <tr>
            ...
            <td >
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuSplitButton2">
                <a class="dropdown-item action-delete"  data-url="{{route('system.company.destroy',[$company->id])}}" data-toggle="modal" data-target="#confirm-delete">Remove Record</a>
              </div>
            </td>
          </tr>
          @empty
