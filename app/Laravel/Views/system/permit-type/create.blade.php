...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Add New Permit Type</li>
  </ol>
</nav>
@stop
...
<div class="col-md-8 grid-margin stretch-card">
  <div class="card">
    <div class="card-body">
      <h4 class="card-title">Permit Type Create Form</h4>
      <form class="create-form" method="POST" enctype="multipart/form-data">
        @include('system._components.notifications')
        {!!csrf_field()!!}
        <div class="form-group">
          <label for="input_suffix">Service Type</label>
          {!!Form::select("service_id", $services, old('service_id'), ['id' => "input_service_id", 'class' => "custom-select mb-2 mr-sm-2 ".($errors->first('service_id') ? 'is-invalid' : NULL)])!!}
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control {{$errors->first('name') ? 'is-invalid' : NULL}}" id="input_title" name="name" placeholder="Permit Type Name" value="{{old('name')}}">
